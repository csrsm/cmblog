...
//博客列表
const blogList = [
  {id: 1, title: '标题1', content: 'Welcome to learning React!'},
  {id: 2, title: '标题2', content: 'You can install React from npm.'},
  {id: 3, title: '标题3', content: 'You can install React from npm.'},
  {id: 4, title: '标题4', content: 'You can install React from npm.'},
  {id: 5, title: '标题5', content: 'You can install React from npm.'},
  {id: 6, title: '标题6', content: 'You can install React from npm.'},
  {id: 6, title: '标题6', content: 'You can install React from npm.'},
  {id: 6, title: '标题6', content: 'You can install React from npm.'},
  {id: 6, title: '标题6', content: 'You can install React from npm.'}
];
